# PowerShell script to start both frontend and backend with proper cleanup
Write-Host "Starting the delivery tracking application with clean environment..." -ForegroundColor Cyan
...
# Start frontend as a job with NODE_OPTIONS to avoid symlink issues
